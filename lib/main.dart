...
import 'attendance_app/features/employee/presentation/screens/employee_list_screen.dart'; // Import Employee List Screen
import 'injection_container.dart' as di; // Import dependency injection setup

void main() {
  di.init(); // Initialize dependency injection setup to register services and BLoCs
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      ...
      providers: [
        BlocProvider(create: (_) => di.sl<AttendanceBloc>()), // Inject AttendanceBloc
        BlocProvider(create: (_) => di.sl<EmployeeBloc>()), // Inject EmployeeBloc
      ],
      child: MaterialApp(
        title: 'Attendance Manager', // App title
        debugShowCheckedModeBanner: false,
        theme: ThemeData(
          colorScheme: ColorScheme.fromSeed(seedColor: Colors.deepPurple), // Theme color setup
